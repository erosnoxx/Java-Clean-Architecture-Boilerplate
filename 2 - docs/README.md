...
Every architectural decision here was made deliberately. If something seems verbose, there's a reason. The [`docs/decisions.md`](docs/decisions.md) explains the thinking behind each one.
